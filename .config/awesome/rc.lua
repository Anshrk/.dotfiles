...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"},            "r",     function () awful.util.spawn("rofi -show run") end,
     ...
     awful.key({ modkey, "Shift" },            "v",     function () awful.util.spawn("pavucontrol") end,
               {description = "run voice control", group = "launcher"}),

    awful.key({ modkey },            "b",     function () awful.util.spawn("brave-browser")   end,
              {description = "run brave browser", group = "launcher"}),

    awful.key({ modkey },            "p",     function () awful.util.spawn("flameshot gui -p /home/ansh/Pictures/screenshots")           end,
